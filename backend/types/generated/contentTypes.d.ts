...
export interface ApiFormForm extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Reusable multi-step and single-step forms';
    displayName: 'Form';
    pluralName: 'forms';
    singularName: 'form';
  };
...
export interface ApiLandingPageLandingPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    sections: Schema.Attribute.DynamicZone<
      [
        'sections.hero',
        'sections.problem-assessment',
        'sections.solution-highlights',
        'sections.case-study-showcase',
        'sections.brand-fit',
        'sections.our-work',
        'sections.client-showcase',
...
export interface ApiLeadLead extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    hasShopifyWebsite: Schema.Attribute.Enumeration<['yes', 'no']>;
    ...
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    shopifyUrl: Schema.Attribute.String;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Slug-based pages built from reusable section components';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
  ...
  attributes: {
    auditBar: Schema.Attribute.Component<'shared.audit-bar', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
