...
export default function ClientShowcase({ data, brands }: ClientShowcaseProps) {
  ...
  return (
    <section className="bg-[#95E7D30D] pt-[clamp(6rem,16vw,9rem)] sm:pt-[clamp(7rem,12vw,10.5rem)] xl:pt-0 flex flex-col justify-between overflow-hidden xl:h-screen xl:min-h-160">
      ...
      <div className="w-full bg-[#4A71A5] shrink-0 overflow-hidden py-[clamp(0.75rem,3vw,1rem)] sm:py-[clamp(1.125rem,1.25vw,1.25rem)] mt-[clamp(5rem,14vw,8.5rem)] sm:mt-[clamp(6.5rem,11vw,9.5rem)] xl:mt-0 select-none">
